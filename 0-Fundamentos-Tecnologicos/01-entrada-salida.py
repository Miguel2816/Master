...
# La extension de los ficheros Python .py (pero no necesariamente)
...
print("El nombre que he escrito es ")
...
print(nombre + " bienvenida a este curso")
print("Hola %s" %nombre)
...
print ("El numero es ", numero) #ojo va coma despues del mensaje

altura=1.38 # ejemplo variable float
print("Tiene %f  altura" %altura)
print("%s tiene %.2f altura" %(nombre, altura)) # %.1f indicamos un decimal
